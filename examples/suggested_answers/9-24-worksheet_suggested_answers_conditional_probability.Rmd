...
\[
P(\text{inoculated}) = \frac{244}{6224} = 
\]
...
\[
P(\text{lived} ~\text{and}~ \text{inoculated}) = \frac{238}{6224} = 
\]
...
\[
P(\text{innoculated} \mid \text{lived}) = \frac{238}{5374} \stackrel{formula}= \frac{P(\text{innoculated} ~\text{and}~ \text{lived})}{P(\text{lived})}= \frac{238}{6224}/\frac{5374}{6224}
\]
...
\[
P(\text{inoculated} \mid \text{died}) = \frac{6}{850} \stackrel{formula}= \frac{P(\text{innoculated} ~\text{and}~ \text{died})}{P(\text{died})} = \frac{6}{6224}/\frac{850}{6224}
\]
