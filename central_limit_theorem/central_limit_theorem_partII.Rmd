...
- Samples need not have the same proportion or the population proportion.
...
100, 500, 1,000, and 5,000 to support our answer experimentally. 
...
In reality, it is not easy to take several samples (for instance, conducting surveys cost a lot of money and effort).  
Often, we rely on few samples if not one. 
...
Z = \frac{x - \mu}{\sigma},
$$
where $\mu$ is the mean and $\sigma$ is the standard deviation. In the proportion setting, we use 
