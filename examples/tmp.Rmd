...
```{r, error=TRUE}
t <- table(smallpox$result, smallpox$inoculated)
t
```
...
6. **What is the probability that a randomly selected person was inoculated?**

   \[
   P(\text{yes}) = \frac{244}{6224} = 0.0392
   \]

---

7. **What is the probability that a person lived and was inoculated?**

   \[
   P(\text{lived} \cap \text{yes}) = \frac{238}{6224} = 0.0382
   \]
...
3. **What is the probability that a person was inoculated, given that they lived?**
   ...
   \[
   P(\text{yes} \mid \text{lived}) = \frac{238}{5374} = 0.0443
   \]

---

9. **If a randomly selected person died, what is the probability that they were inoculated?**

   \[
   P(\text{yes} \mid \text{died}) = \frac{6}{850} = 0.0071
   \]

---
---

2. **What is the probability that a randomly selected person died, given that they were not inoculated?**

   \[
   P(\text{died} \mid \text{no}) = \frac{844}{5980} = 0.1411
   \]

---

4. **What is the probability that a person was not inoculated, given that they died?**

   \[
   P(\text{no} \mid \text{died}) = \frac{844}{850} = 0.993
   \]

---

5. **If a person was not inoculated, what is the probability that they lived?**

   \[
   P(\text{lived} \mid \text{no}) = \frac{5136}{5980} = 0.8589
   \]

---

8. **What is the probability that a person died, given that they were inoculated?**

   \[
   P(\text{died} \mid \text{yes}) = \frac{6}{244} = 0.0246
   \]

---

10. **What is the probability that a person lived, given that they were not inoculated?**
